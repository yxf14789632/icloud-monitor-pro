...
import { DeptFormData, DeptQueryParam } from '@/types'
 ...
 * @param queryParams
 */
export function listTableDepartments(queryParams?: DeptQueryParam) {
  return request({
    url: '/api/v1/depts/table',
    method: 'get',
    params: queryParams
  })
}
 ...
 * @param id
 */
export function getDeptFormDetail(id: number) {
  return request({
    url: '/api/v1/depts/' + id,
    method: 'get'
  })

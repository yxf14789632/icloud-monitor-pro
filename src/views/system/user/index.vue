<template>
  <div class="app-container">
    <el-row>
      <!-- 部门数据 -->
      <el-col :span="4" :xs="24" style="background: #fff">
        <div style="margin: 12px">
          ...
          <el-tree
            ref="deptTreeRef"
            :data="deptOptions"
            :props="{ children: 'children', label: 'label', disabled: 'false' }"
      ...
      <el-col :span="20" :xs="24">
        <div style="margin: 0 12px; background: #fff; padding: 12px">
...
import { listDeptsForSelect } from '@/service/system/dept'
import { listRoles } from '@/service/system/role'
import {
  addUser,
  deleteUsers,
  getUserFormDetail,
...
import { ref, onMounted, reactive, toRefs, unref, watchEffect } from 'vue'

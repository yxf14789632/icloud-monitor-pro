...
import { listRolePerms, saveRolePerms } from '@/service/system/role'
import { onMounted, reactive, toRefs, watch } from 'vue'
import { ElMessage } from 'element-plus'
import { Check } from '@element-plus/icons-vue'
import { listPerms } from '@/service/system/perm'
...
function loadData() {
  ...
  state.loading = true
  listPerms({ menuId: props.menu.id }).then((response: any) => {
    state.permissionOptions = response.data
    listRolePerms(props.role.id, props.menu.id).then((res: any) => {
